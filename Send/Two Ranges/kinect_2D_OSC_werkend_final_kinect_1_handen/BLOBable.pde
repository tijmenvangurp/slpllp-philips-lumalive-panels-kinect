...
//new BLOBable class, that implements the BLOBable-interface.
public final class BLOBable_Kinect_2D_2 implements BLOBable{
  int width_, height_;
  private String name_; 
  ...
  public BLOBable_Kinect_2D_2(PApplet papplet){
    papplet_ = papplet;
  }
  
  public BLOBable_Kinect_2D_2 setKinectDepth(KinectFrameDepth kinect_depth){
    kinect_depth_ = kinect_depth;
    return this;
  }
