class Handen {
  ...
  int theColor = 0;
  color[] colors = {color(0,0,255), color(0,255,0),  color(255,0,0), color(255), color(111,0,255), color(255, 255, 0), color(0, 255, 255), color(127,0,255), color(255,0,255), color(0,255,0)};
